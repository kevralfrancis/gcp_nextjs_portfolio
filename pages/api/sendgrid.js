...
sendgrid.setApiKey("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");


async function sendEmail(req, res) {
    try {
      await sendgrid.send({
        to: "franciskevral@gmail.com", // Your email where you'll receive emails
        from: "info@kevralfrancisportfolio.com", // your website email address here
